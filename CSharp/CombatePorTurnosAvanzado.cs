...
public class Personaje
{
    ...
    public virtual void SetNivel(int nuevoNivel)
    {
        Nivel = nuevoNivel;
...
public class Jugador : Personaje
{
    ...
    public override void Atacar(Personaje objetivo)
    {
        ...
        Console.WriteLine("El jugador ha golpeado gravemente al enemigo.");
    }
    ...
    public override void SetNivel(int nuevoNivel)
    {
        base.SetNivel(nuevoNivel);
...
public class Enemigo : Personaje
{
    ...
    {
        base.Atacar(objetivo);
        Console.WriteLine("El enemigo lanzo un contraataque");
    }
}
